...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            var slideOffeset = -3000;
            var sidebarOffeset = $('.page-sidebar li.open').parents().height();
            var sidebar = $('.page-sidebar');
                ...
                sub.slideDown(slideSpeed, function () {
                    if (autoScroll === true && $('body').hasClass('page-sidebar-closed') === false) {
                        if ($('body').hasClass('page-sidebar-fixed')) {
                            ...
                            // sidebar.scrollTo(this, sidebarOffeset);
                            // Metronic.scrollTo(the, slideOffeset);
        ...
        jQuery('.page-sidebar').on('click', 'ul.sub-menu > li > a', function (e) {

            var slideOffeset = -3000;


             Metronic.scrollTo($(this), slideOffeset);
