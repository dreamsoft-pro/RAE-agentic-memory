angular.module('digitalprint.services')
    .factory('ProcessService', function ($rootScope, $q, $http, $config, $cacheFactory) {
        ...
        ProcessService.create = function (data) {
            var def = $q.defer();
        ...
        ProcessService.update = function (module) {
            var def = $q.defer();
        ...
        ProcessService.remove = function (id) {
            var def = $q.defer();
        ...
        ProcessService.sort = function (sort) {
            var def = $q.defer();
