(function () {
    ...
    function ngGallery($document, $timeout, $q, $templateCache) {
        ...
        $templateCache.put(template_url,
            ...
            '    <img loading="lazy" ng-src="{{ i.thumb }}" class="{{ thumbClass }}" ng-click="openGallery($index)" alt="Image {{ $index + 1 }}" />' +
            '  </div>' +
            '</div>' +
            ...
            '  <img loading="lazy" ondragstart="return false;" draggable="false" ng-src="{{ img }}" ng-click="nextImage()" ng-show="!loading" class="effect" />' +
            ...
            '      <div ng-repeat="i in images">' +
            '        <img loading="lazy" ng-src="{{ i.thumb }}" ng-class="{\'active\': index === $index}" ng-click="changeImage($index)" />' +
            '      </div>' +
            '    </div>' +
            '  </div>' +
            '</div>'
