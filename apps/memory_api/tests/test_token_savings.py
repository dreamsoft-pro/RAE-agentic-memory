...
from apps.memory_api.models.token_savings import TokenSavingsEntry, SavingsSummary
...
async def test_track_savings_positive(service, mock_repo):
    ...
    with patch("apps.memory_api.services.token_savings_service.calculate_cost") as mock_calc:
