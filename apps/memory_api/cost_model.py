...
MODEL_COSTS = {
    ...
    # --- Anthropic ---
    "claude-sonnet-4-5-20250929": {"input": 3.0, "output": 15.0}, # Placeholder, assuming Sonnet 4.5 is similar to 3.5
    "claude-haiku-4-5-20251001": {"input": 0.25, "output": 1.25}, # Placeholder, assuming Haiku 4.5 is similar to 3
    "claude-opus-4-1-20250805": {"input": 15.0, "output": 75.0}, # Placeholder, assuming Opus 4.1 is similar to 4
    ...
    "models/gemini-1.5-pro-002": {"input": 2.0, "output": 6.0}, # Placeholder costs, adjust as per actual pricing
