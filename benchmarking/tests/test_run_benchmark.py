...
from run_benchmark import BenchmarkMetrics
...
class TestBenchmarkMetrics:
    ...
    def test_calculate_precision_at_k_perfect(self):
        ...
        assert abs(precision - expected_precision) < 0.01, f"Precision should be {expected_precision:.3f}"
    ...
    def test_calculate_recall_at_k_perfect(self):
        ...
        results = [
            ...
            (['doc1', 'doc2', 'doc3'], ['doc1', 'doc2', 'doc3', 'doc4', 'doc5']),  # 3/3 = 1.0
        ]
    ...
    def test_calculate_recall_at_k_partial(self):
        ...
        assert abs(recall - expected_recall) < 0.01, f"Recall should be {expected_recall:.3f}"
...
class TestBenchmarkIntegration:
    ...
    def test_yaml_files_exist(self):
        ...
        assert (benchmark_dir / 'academic_lite.yaml').exists(), "academic_lite.yaml should exist"
        assert (benchmark_dir / 'academic_extended.yaml').exists(), "academic_extended.yaml should exist"
        assert (benchmark_dir / 'industrial_small.yaml').exists(), "industrial_small.yaml should exist"
    ...
    def test_scripts_directory_exists(self):
        ...
        assert (scripts_dir / 'run_benchmark.py').exists(), "run_benchmark.py should exist"
        assert (scripts_dir / 'compare_runs.py').exists(), "compare_runs.py should exist"
