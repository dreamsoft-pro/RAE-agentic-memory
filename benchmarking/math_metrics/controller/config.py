...
class SafetyConfig:
    ...
    l3_blacklist_profiles: List[str] = field(default_factory=lambda: ["production", "cheap"])
...
class MathControllerConfig:
    ...
    allowed_levels: List[MathLevel] = field(default_factory=lambda: [
        MathLevel.L1, MathLevel.L2, MathLevel.L3
    ])
    ...
    def __post_init__(self):
        ...
        if not self.strategies:
            self.strategies = {
                ...
                MathLevel.L2: ["default", "entropy_minimization", "information_bottleneck", "mutual_information"],
...
def load_config(config_path: str) -> MathControllerConfig:
    ...
    # Parse default level
    default_level = MathLevel(raw_config.get("default_level", "deterministic_heuristic"))
    ...
    safety_config = SafetyConfig(
        ...
        l3_blacklist_profiles=safety_raw.get("l3_blacklist_profiles", ["production", "cheap"]),
    )
