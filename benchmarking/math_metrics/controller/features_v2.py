...
class FeaturesV2(Features):
    ...
    recent_quality_scores: List[float] = field(default_factory=list)  # Last N quality scores
    ...
    def compute_derived_features(self) -> Dict[str, float]:
        ...
        return {
            ...
            # Budget pressure
            "budget_tight": 1.0 if (self.cost_budget and self.cost_budget < 0.01) else 0.0,
            "latency_tight": 1.0 if (self.latency_budget_ms and self.latency_budget_ms < 100) else 0.0,
