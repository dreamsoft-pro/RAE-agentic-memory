...
async def test_check_budget():
    ...
    mock_pool.fetchrow.return_value = {
        ...
        "monthly_limit_usd": 10.0, "monthly_usage_usd": 5.0,
        "daily_limit_usd": 1.0, "daily_usage_usd": 0.5,
        "monthly_tokens_limit": None, "monthly_tokens_used": 0,
        "daily_tokens_limit": None, "daily_tokens_used": 0,
...
async def test_check_budget_fail():
    ...
    mock_pool.fetchrow.return_value = {
        "id": "b1", "tenant_id": "t1", "project_id": "p1",
        "monthly_limit_usd": 10.0, "monthly_usage_usd": 5.0,
        "daily_limit_usd": 1.0, "daily_usage_usd": 0.9,
        "monthly_tokens_limit": None, "monthly_tokens_used": 0,
        "daily_tokens_limit": None, "daily_tokens_used": 0,
        "created_at": datetime.now(),
        "last_usage_at": datetime.now(),
