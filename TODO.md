...
*Last scan: 2026-01-27 18:37*

- [ ] **CHANGELOG.md:4582** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4624** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4665** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4706** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4741** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4776** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4806** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4836** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4865** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4893** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4917** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4941** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4959** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:4977** - - resolve conflict in TODO.md ([`c3694b8`](../../commit/c3694b8))
- [ ] **CHANGELOG.md:5261** - - update TODO with DevOps & Infrastructure completion status ([`9c51694`](../../commit/9c51694))
- [ ] **CHANGELOG.md:5324** - - update project status and TODO list after iteration 2 completion ([`40bc5a8`](../../commit/40bc5a8))
- [ ] **CHANGELOG.md:5325** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`9af286a`](../../commit/9af286a))
- [ ] **CHANGELOG.md:5822** - - update TODO with DevOps & Infrastructure completion status ([`9c51694`](../../commit/9c51694))
- [ ] **CHANGELOG.md:5885** - - update project status and TODO list after iteration 2 completion ([`40bc5a8`](../../commit/40bc5a8))
- [ ] **CHANGELOG.md:5886** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`9af286a`](../../commit/9af286a))
- [ ] **CHANGELOG.md:6390** - - update TODO with DevOps & Infrastructure completion status ([`9c51694`](../../commit/9c51694))
- [ ] **CHANGELOG.md:6453** - - update project status and TODO list after iteration 2 completion ([`40bc5a8`](../../commit/40bc5a8))
- [ ] **CHANGELOG.md:6454** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`9af286a`](../../commit/9af286a))
- [ ] **CHANGELOG.md:6950** - - update TODO with DevOps & Infrastructure completion status ([`9c51694`](../../commit/9c51694))
- [ ] **CHANGELOG.md:7013** - - update project status and TODO list after iteration 2 completion ([`40bc5a8`](../../commit/40bc5a8))
- [ ] **CHANGELOG.md:7014** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`9af286a`](../../commit/9af286a))
- [ ] **CHANGELOG.md:7509** - - update TODO with DevOps & Infrastructure completion status ([`9c51694`](../../commit/9c51694))
- [ ] **CHANGELOG.md:7572** - - update project status and TODO list after iteration 2 completion ([`40bc5a8`](../../commit/40bc5a8))
- [ ] **CHANGELOG.md:7573** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`9af286a`](../../commit/9af286a))
- [ ] **CHANGELOG.md:8059** - - update TODO with DevOps & Infrastructure completion status ([`9c51694`](../../commit/9c51694))
- [ ] **CHANGELOG.md:8122** - - update project status and TODO list after iteration 2 completion ([`40bc5a8`](../../commit/40bc5a8))
- [ ] **CHANGELOG.md:8123** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`9af286a`](../../commit/9af286a))
- [ ] **CHANGELOG.md:8608** - - update TODO with DevOps & Infrastructure completion status ([`9c51694`](../../commit/9c51694))
- [ ] **CHANGELOG.md:8671** - - update project status and TODO list after iteration 2 completion ([`40bc5a8`](../../commit/40bc5a8))
- [ ] **CHANGELOG.md:8672** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`9af286a`](../../commit/9af286a))
- [ ] **CHANGELOG.md:9156** - - update TODO with DevOps & Infrastructure completion status ([`9c51694`](../../commit/9c51694))
- [ ] **CHANGELOG.md:9219** - - update project status and TODO list after iteration 2 completion ([`40bc5a8`](../../commit/40bc5a8))
- [ ] **CHANGELOG.md:9220** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`9af286a`](../../commit/9af286a))
- [ ] **CHANGELOG.md:9704** - - update TODO with DevOps & Infrastructure completion status ([`5215c60`](../../commit/5215c60))
...
- [ ] **CHANGELOG.md:10272** - - update TODO with DevOps & Infrastructure completion status ([`5215c60`](../../commit/5215c60))
- [ ] **CHANGELOG.md:10335** - - update project status and TODO list after iteration 2 completion ([`49aff83`](../../commit/49aff83))
- [ ] **CHANGELOG.md:10336** - - Update TODO with Test Coverage Roadmap (Phase 3) ([`934b3a9`](../../commit/934b3a9))
...
- [ ] **apps/memory_api/services/hybrid_search.py:320** - connected_components=1,   TODO: compute from graph
...
- [ ] **rae-core/rae_core/search/strategies/multi_vector.py:108** - Add logging
