...
from rae_core.math.structure import cosine_similarity, ScoringWeights
...
class MathLayerController:
    ...
    def get_retrieval_weights(self, query: str, context: Optional[Dict] = None) -> Dict[str, float]:
        """
    ...
    def _build_features(self, query: str, context: Optional[Dict] = None) -> FeaturesV2:
    ...
    def apply_decay(self, age_hours: float, usage_count: int = 0) -> float:
        ...
        created_at = now - datetime.timedelta(hours=age_hours)
