...
from rae_core.rae_math.bandit.arm import Arm
from rae_core.rae_math.bandit.bandit import BanditConfig, MultiArmedBandit
from rae_core.rae_math.features_v2 import FeatureExtractorV2
from rae_core.rae_math.structure import ScoringWeights, cosine_similarity
from rae_core.rae_math.types import MathLevel
...
class MathLayerController:
    ...
    def compute_similarity(self, v1: list[float], v2: list[float]) -> float:
        ...
        from rae_core.rae_math.structure import cosine_similarity
        return cosine_similarity(v1, v2)

    def apply_decay(self, age_hours: float, usage_count: int) -> float:
        """Helper for legacy tests."""
        from datetime import datetime, timezone, timedelta
        from rae_core.rae_math.dynamics import calculate_recency_score
