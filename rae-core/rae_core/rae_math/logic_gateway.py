...
from rae_core.rae_math.metadata_injector import MetadataInjector
from rae_core.rae_math.resonance import SemanticResonanceEngine
...
class LogicGateway:
    ...
    def strategies(self):
        if self._strategies is None:
            ...
            from rae_core.rae_math.fusion import Legacy416Strategy, SiliconOracleStrategy
            self._strategies = {
