...
def upgrade():
    op.create_table(
        ...
        sa.Column('node_id', sa.String(), nullable=False, index=True), # The unique business ID of the node
    ...
    op.create_table(
        ...
        sa.Column('tenant_id', sa.String(), nullable=False, index=True),
        sa.Column('project_id', sa.String(), nullable=False, index=True),
        sa.Column('source_node_id', UUID(as_uuid=True), sa.ForeignKey('knowledge_graph_nodes.id', ondelete='CASCADE'), nullable=False),
        sa.Column('target_node_id', UUID(as_uuid=True), sa.ForeignKey('knowledge_graph_nodes.id', ondelete='CASCADE'), nullable=False),
