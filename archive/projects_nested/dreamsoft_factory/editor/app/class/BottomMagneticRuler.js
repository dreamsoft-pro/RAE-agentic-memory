...
(function(){
    ...
    function BottomMagneticRuler( tolerance ){
    ...
    var p = BottomMagneticRuler.prototype = $.extend( true, {}, Object.create( Editor.EditorRullerHelper_Horizontal.prototype ) );
    
    p.constructor = BottomMagneticRuler;
        ...
        if( linesInRange.length ){
            ...
            for( var i=0; i < linesInRange.length; i++ ){
                ...
                if( this.closestLine ){
                    ...
                    if( (Math.abs( this.y - this.closestLine.y ))*currentScale > (Math.abs( this.y - linesInRange[i].y ))*currentScale ){
    ...
    Editor.BottomMagneticRuler = BottomMagneticRuler;
