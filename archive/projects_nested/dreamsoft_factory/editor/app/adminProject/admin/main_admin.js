...
import {ProjectImage} from './../../class/ProjectImage';
    ...
    var adminProject = function( editor ){
        ...
        */
        ...
        function getFormatDialogContent(){
        ...
        */
        var loadWS = function( projectData, adminProjectID ){
            ...
            var formatID=Editor.getURLParameters()['formatID']
            if(formatID){
                var format = Editor.getAttributesOptions()[formatID];
                Editor.webSocketControllers.format.load(
                    adminProjectID,
                    format.name,
                    format.ID,
                    format.width,
                    format.height,
                    format.slope,function( data ){

                    Editor.adminProject.format.init( data );

                });
            }else{
                Editor.template.formatSelectWindow( getFormatDialogContent() );
            }
