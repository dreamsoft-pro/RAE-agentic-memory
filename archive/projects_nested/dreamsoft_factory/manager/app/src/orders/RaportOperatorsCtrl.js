angular.module('digitalprint.app')
    .controller('orders.RaportOperatorsCtrl', function($state, $rootScope, $filter, $scope, Notification, DeviceService,
        ...
        function getRaport(){
            ...
            OngoingService.getAllOperatorLogs(dates).then(function (data) {
                $scope.operatorsData = data;
            });
        }
