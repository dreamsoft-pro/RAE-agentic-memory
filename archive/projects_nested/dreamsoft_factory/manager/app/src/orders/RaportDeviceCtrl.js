angular.module('digitalprint.app')
    .controller('orders.RaportDeviceCtrl', function($state, $rootScope, $filter, $scope, Notification, DeviceService,
        ...
        function getRaport(){
            ...
            OngoingService.getDeviceLogs($scope.deviceID, dates).then(function (data) {
                var ongoingsByDate = [];
