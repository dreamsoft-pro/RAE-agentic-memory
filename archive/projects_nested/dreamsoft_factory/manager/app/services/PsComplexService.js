...
angular.module('digitalprint.services')
    .factory('PsComplexService', function ($q, $http, $config, $cacheFactory) {
        ...
        ComplexService.prototype.relatedFormat = function (baseFormatID, complexID) {
            var def = $q.defer();
            ...
            $http({
                method: 'GET',
                url: $config.API_URL + [resource, 'relatedFormat', baseFormatID].join('/') + '?complexID=' + complexID
            }).success(function (data) {
                def.resolve(data);
            }).error(function (data) {
                def.reject(data);
        ...
        ComplexService.prototype.saveRelatedFormat = function (baseFormatID, formats, complexID) {
            var def = $q.defer();
            ...
            $http({
                ...
                data: {formats: formats, complexID: complexID}
            }).success(function (data) {
                if (data.response) {
                    cache.remove(resource);
                    def.resolve(data);
        ...
        ComplexService.prototype.getByBaseID = function (baseTypeID) {
            var def = $q.defer();
            ...
            $http({
                method: 'GET',
                url: $config.API_URL + [resource, 'getByBaseID', baseTypeID].join('/')
            }).success(function (data) {
                def.resolve(data);
            }).error(function (data) {
                def.reject(data);
