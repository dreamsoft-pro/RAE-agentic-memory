...
**Generation**: On-demand via RAE API `/v2/memories/reflection/hierarchical`
...
2. Check API key is valid:
   ```bash
   curl -H "X-API-Key: your-key" http://localhost:8000/v2/memories/query
   ```
...
ab -n 100 -c 10 -T application/json -p payload.json http://localhost:8000/v2/memories/store
