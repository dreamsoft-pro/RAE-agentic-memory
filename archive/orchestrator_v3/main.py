...
from orchestrator_v3.adapters import (
    ClaudeAdapter,
    ClaudeAdapter,
    ModelType,
    TaskComplexity,
...
from orchestrator_v3.agents import (
    AgentTask,
    CodeReviewerAgent,
    ImplementerAgent,
    PlannerAgent,
...
from orchestrator_v3.core.model_router import ModelRouter
from orchestrator_v3.core.quality_gate import QualityGate
from orchestrator_v3.core.telemetry import init_telemetry
...
class Orchestrator:
    ...
    def _get_adapter(self, model_type: ModelType):
        ...
        if model_type == ModelType.CLAUDE_SONNET:
            ...
            return OllamaAdapter(model_type, str(self.working_dir))
